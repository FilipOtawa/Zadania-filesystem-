...
int main() {
    ...
    //     ZADANIE 2.
    // Przyrównaj funkcje z <filesystem> do typu file_time_type tak żeby wyświetlić datę ostatniej modyfikacji pliku z zadania 1 (ma to być akutalny czas).
    ...
    // Odkomentuj po zrobieniu zadania 1:
